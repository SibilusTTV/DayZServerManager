...
namespace Migrations.Migrations
{
    ...
    [Migration("20260902221355_AddedPositionToModsJoinTables")]
    partial class AddedPositionToModsJoinTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Manager.InstanceClientMod", b =>
                {
                    ...
                    b.Property<int>("clientModsInstanceId")
                        .HasColumnType("INTEGER");

                    b.Property<string>("clientModsModId")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("clientModsInstanceId", "clientModsModId");
            ...
            modelBuilder.Entity("Domain.Manager.InstanceServerMod", b =>
                {
                    ...
                    b.Property<int>("serverModsInstanceId")
                        .HasColumnType("INTEGER");

                    b.Property<string>("serverModsModId")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("serverModsInstanceId", "serverModsModId");
            ...
            modelBuilder.Entity("Domain.Manager.InstanceClientMod", b =>
                {
                    ...
                    b.HasOne("Domain.Manager.InstanceClientMod", null)
                        .WithMany()
                        .HasForeignKey("clientModsInstanceId", "clientModsModId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Manager.InstanceServerMod", b =>
                {
                    ...
                    b.HasOne("Domain.Manager.InstanceServerMod", null)
                        .WithMany()
                        .HasForeignKey("serverModsInstanceId", "serverModsModId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
