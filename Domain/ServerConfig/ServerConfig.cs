...
public class ServerConfig
{
    ...
    public void SetDefaultValues()
    {
        ...
        Properties.Add(new PropertyValue(35, "steamPort", DataType.Number, 2301, ""));
        Properties.Add(new PropertyValue(36, "steamQueryPort", DataType.Number, 2305, "defines Steam query port, should fix the issue with server not being visible in client server browser"));
        Properties.Add(new PropertyValue(37, "allowFilePatching", DataType.Number, 1, "if set to 1 it will enable connection of clients with \"-filePatching\" launch parameter enabled"));
        Properties.Add(new PropertyValue(38, "simulatedPlayersBatch", DataType.Number, 20, "Set limit of how much players can be simulated per frame (for server performance gain)"));
        Properties.Add(new PropertyValue(39, "multithreadedReplication", DataType.Number, 1, "enables multi-threaded processing of server's replication system. Number of worker threads is derived by settings of jobsystem in dayzSettings.xml by \"maxcores\" and \"reservedcores\" parameters (value 0-1)"));
        Properties.Add(new PropertyValue(40, "speedhackDetection", DataType.Number, 1, "enable speedhack detection, values 1-10 (1 strict, 10 benevolent, can be float)"));
        Properties.Add(new PropertyValue(41, "networkRangeClose", DataType.Number, 20, "network bubble distance for spawn of close objects with items in them (f.i. backpacks), set in meters, default value if not set is 20"));
        Properties.Add(new PropertyValue(42, "networkRangeNear", DataType.Number, 150, "network bubble distance for spawn (despawn +10%) of near inventory items objects, set in meters, default value if not set is 150"));
        Properties.Add(new PropertyValue(43, "networkRangeFar", DataType.Number, 1000, "network bubble distance for spawn (despawn +10%) of far objects (other than inventory items), set in meters, default value if not set is 1000"));
        Properties.Add(new PropertyValue(44, "networkRangeDistantEffect", DataType.Number, 4000, "network bubble distance for spawn of effects (currently only sound effects), set in meters, default value if not set is 4000"));
        Properties.Add(new PropertyValue(45, "networkObjectBatchLogSlow", DataType.Number, 5, "Maximum time a bubble can take to iterate in seconds before it is logged to the console"));
        Properties.Add(new PropertyValue(46, "networkObjectBatchEnforceBandwidthLimits", DataType.Number, 1, "Enables a limiter for object creation based on bandwidth statistics"));
        Properties.Add(new PropertyValue(47, "networkObjectBatchUseEstimatedBandwidth", DataType.Number, 0, "Switch between the method behind finding the bandwidth usage of a connection. If set to 0, it will use the total of the actual data sent since the last server frame, and if set to 1, it will use a crude estimation"));
        Properties.Add(new PropertyValue(48, "networkObjectBatchUseDynamicMaximumBandwidth", DataType.Number, 1, "Determines if the bandwidth limit should be a factor of the maximum bandwidth that can be sent or a hard limit. The maximum bandwidth that can be sent fluctuates depending on demand in the system."));
        Properties.Add(new PropertyValue(49, "networkObjectBatchBandwidthLimit", DataType.Decimal, 0.8f, "The actual limit, could be a [0,1] value or a [1,inf] value depending on networkObjectBatchUseDynamicMaximumBandwidth. See above"));
        Properties.Add(new PropertyValue(50, "networkObjectBatchCompute", DataType.Number, 1000, "Number of objects in the create/destroy lists that are checked in a single server frame"));
        Properties.Add(new PropertyValue(51, "networkObjectBatchSendCreate", DataType.Number, 10, "Maximum number of objects that can be sent for creation"));
        Properties.Add(new PropertyValue(52, "networkObjectBatchSendDelete", DataType.Number, 10, "Maximum number of objects that can be sent for deletion"));
        Properties.Add(new PropertyValue(53, "defaultVisibility", DataType.Number, 1375, "highest terrain render distance on server (if higher than \"viewDistance=\" in DayZ client profile, clientside parameter applies)"));
        Properties.Add(new PropertyValue(54, "defaultObjectViewDistance", DataType.Number, 1375, "highest object render distance on server (if higher than \"preferredObjectViewDistance=\" in DayZ client profile, clientside parameter applies)"));
        Properties.Add(new PropertyValue(55, "lightingConfig", DataType.Number, 0, "0 for brighter night, 1 for darker night"));
        Properties.Add(new PropertyValue(56, "disablePersonalLight", DataType.Number, 1, "disables personal light for all clients connected to server"));
        Properties.Add(new PropertyValue(57, "disableBaseDamage", DataType.Number, 0, "set to 1 to disable damage/destruction of fence and watchtower"));
        Properties.Add(new PropertyValue(58, "disableContainerDamage", DataType.Number, 0, "set to 1 to disable damage/destruction of tents, barrels, wooden crate and seachest"));
        Properties.Add(new PropertyValue(59, "disableRespawnDialog", DataType.Number, 0, "set to 1 to disable the respawn dialog (new characters will be spawning as random)"));
        Properties.Add(new PropertyValue(60, "pingWarning", DataType.Number, 200, "set to define the ping value from which the initial yellow ping warning is triggered (value in milliseconds)"));
        Properties.Add(new PropertyValue(61, "pingCritical", DataType.Number, 250, "set to define the ping value from which the red ping warning is triggered (value in milliseconds)"));
        Properties.Add(new PropertyValue(62, "MaxPing", DataType.Number, 300, "set to define the ping value from which a player is kicked from the server (value in milliseconds)"));
        Properties.Add(new PropertyValue(63, "serverFpsWarning", DataType.Number, 15, "set to define the server fps value under which the initial server fps warning is triggered (minimum value is 11)"));
        Properties.Add(new PropertyValue(64, "BattlEye", DataType.Number, 1, "Turn on BattlEye"));
        // Properties.Add(new PropertyValue(64, "shardId", DataType.Text, "123abc", "Six alphanumeric characters for Private server"));
        Properties.Add(new PropertyValue(65, "description", DataType.TextLong, "Test Server", "Description of the server. Gets displayed to users in client server browser."));
        Properties.Add(new PropertyValue(66, "steamProtocolMaxDataSize", DataType.Number, 4096, "How big the data size of the protocol can be. If you have trouble with people that get kicked, decrease the size."));
        Properties.Add(new PropertyValue(67, "motdInterval", DataType.Number, 1, "Time interval (in seconds) between each message"));
        Properties.Add(new PropertyValue(68, "motd[]", DataType.Array, new List<string> { "line1", "line2" }, "Message of the day displayed in the in-game chat"));
        Properties.Add(new PropertyValue(69, "template", DataType.Text, "dayzOffline.chernarusplus", "Mission to load on server startup. <MissionName>.<TerrainName>"));
    }
